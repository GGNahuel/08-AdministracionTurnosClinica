export function ConfigIcon ({color = "#000000"} : {color?: string}) {
  return (
    <svg className="icon dark" width="800px" height="800px" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path clipRule="evenodd" d="M14 20C17.3137 20 20 17.3137 20 14C20 10.6863 17.3137 8 14 8C10.6863 8 8 10.6863 8 14C8 17.3137 10.6863 20 14 20ZM18 14C18 16.2091 16.2091 18 14 18C11.7909 18 10 16.2091 10 14C10 11.7909 11.7909 10 14 10C16.2091 10 18 11.7909 18 14Z" 
        fill={color} fillRule="evenodd" strokeWidth="0.5"/>
...
export function LanguageIcon ({color = "#000000"} : {color?: string}) {
  return (
    <svg className="icon dark" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7.99998 3H8.99998C7.04998 8.84 7.04998 15.16 8.99998 21H7.99998" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M15 3C16.95 8.84 16.95 15.16 15 21" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 16V15C8.84 16.95 15.16 16.95 21 15V16" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 9.0001C8.84 7.0501 15.16 7.0501 21 9.0001" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
...
export function LogInIcon ({color = "#000000"} : {color?: string}) {
  return (
    <svg className="icon" width="800px" height="800px" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" id="Stock_cut" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <desc/>
      <g>
        <polyline fill="none" points="21,18 21,11    11,1 1,11 1,31 21,31 21,24  " stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"/>
        <line fill="none" stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2" x1="32" x2="11" y1="21" y2="21"/>
        <polyline fill="none" points="17,27 11,21    17,15  " stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"/>
      </g>
    </svg>
  )
}
...
export function LogOutIcon ({color = "#000000"} : {color?: string}) {
  return (
    <svg className="icon" width="800px" height="800px" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" id="Stock_cut" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      ...
      <g>
        <polyline fill="none" points="21,18 21,11    11,1 1,11 1,31 21,31 21,24  " stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"/>
        <line fill="none" stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2" x1="10" x2="31" y1="21" y2="21"/>
        <polyline fill="none" points="25,15 31,21    25,27  " stroke={color} strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"/>
      </g>
    </svg>
  )
}
...
export function LoupeIcon ({color = "#000000"} : {color?: string}) {
  return (
    <svg className="icon" fill={color} height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve" transform="matrix(-1, 0, 0, 1, 0, 0)">
      <g id="SVGRepo_bgCarrier" strokeWidth="16"/>
...
export function UserIcon({isDark} : {isDark?: boolean}) {
  return (
    <svg className={isDark ? "icon dark" : "icon"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
      <g id="SVGRepo_iconCarrier"> 
        <circle cx="12" cy="6" r="4" strokeWidth="2"></circle> 
        <path opacity="1" d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" strokeWidth="2"></path> 
      </g>
    </svg>  
  )
}